...
function preparandoBolo(minutos) {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (minutos >= 35) {
            ...
            reject("O bolo esta queimado")

        } else

            if (minutos < 15) {

                reject("O bolo esta cru")


            } else {


                resolve('o bolo esta assado')
            }
...
function verificarNumeroMaiorOuMenor(numeroAleatorio) {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (numeroAleatorio > 5) {
            ...
            resolve("Acertou miseravel")

        }

        reject("Errou miseravel")
...
verificarNumeroMaiorOuMenor(Math.floor(Math.random() * 10) + 1).then(resultado=> console.log(resultado)
).catch(erro => console.log(erro)
).finally(()=> console.log('finalizou a verificação')
)